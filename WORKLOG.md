...
- **ระบบกำหนดคะแนนเต็มของใบงานโดยตรง (Explicit Task Max Score)**:
  ...
  - *การเปลี่ยนแปลงด้าน Database*: เพิ่มคอลัมน์ `maxScore Float @default(10)` ในตาราง `Task` ของ Prisma Schema
  - *การเปลี่ยนแปลงด้าน UI/UX*:
    - ในแถบเมนูจัดการใบงานห้องเรียน เพิ่มช่องให้กรอกคะแนนเต็มควบคู่กับการป้อนชื่อตอน "เพิ่มใบงานใหม่" (ค่าเริ่มต้นคือ 10 คะแนน)
    - ในรายการใบงาน เพิ่มช่องสำหรับป้อนหรือแก้ไขคะแนนเต็มสำหรับแต่ละใบงาน ทำให้สามารถเซฟบันทึกแบบกลุ่ม (Batch Save) พร้อมจัดอันดับ/เปลี่ยนชื่อ/สลับรูปภาพได้ในขั้นตอนเดียว
